...
export default function NavBar(){
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row md:items-center">
    <nav className={`lg:space-x-5 px-5 md:px-0 font-pops  text-black font-semibold flex flex-col mt-6 md:mt-0 space-y-2 lg:space-y-0 ${opened?'':'md:block hidden'} md:flex-row lg:w-2/5 my-2 md:my-0 md:items-center  text-base md:ml-auto`}>
    ...
    <div className={`lg:w-2/5  inline-flex lg:justify-end ml-5 lg:ml-0 ${opened?'':'md:inline-flex hidden'}`}>
      <button className="inline-flex rounded-full transition-all ease-linear duration-300 items-center text-white font-semibold bg-black border-0 py-2 px-5 focus:outline-none hover:bg-black/90 text-base mt-4 md:mt-0">Sign Up
