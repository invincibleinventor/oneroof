...
export default function NavBar(){
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row md:items-center">
    <nav className={`lg:space-x-5 font-medium flex flex-col mt-6 md:mt-0 space-y-2 lg:space-y-0 ${opened?'':'md:block hidden'} md:flex-row lg:w-2/5 my-2 md:my-0 md:items-center  text-base md:ml-auto`}>
