...
export default function Home() {
  ...
  <div className="py-8 px-10 mx-auto max-w-screen-xl w-full flex flex-col items-center content-center sm:py-14 lg:px-6">
      <div className="max-w-screen-md w-full mb-10 md:mt-0 mt-4 md:mb-14">
          <h2 className="mb-4 text-4xl tracking-tight text-center mx-auto font-semibold text-white"><span className="text-purple-300 font-bold">One</span> central place for all your needs</h2>
          <p className=" sm:text-base my-5 text-gray-300 text-center mx-auto">Here at OneRoof, we provide the one central solution for all the needs of every <div className="w-max inline-block text-white font-semibold transform skew-6">SASTRA</div> student. From a rental marketplace - to a lost and find system, we have got everything covered for you!</p>
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          ...
          <div className="shadow-xl duration-200 ease-linear transition-all bg-black bg-opacity-0  px-6 py-6 lg:py-12">
